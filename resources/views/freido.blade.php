...
<div class="container" style="margin-left:25%;">
  ...
  <br>
    <div class="row text-center">
      ...
      <br>
      <div class="col-lg">
        <h1 class="text-center font-weight-bold">Freido</h1>
      ...
      <tr>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form  id="actualizar-{{$item->id}}" action=" {{route('freido.actualizar', $item->id)}} " method="POST">
                    @method('put')
                    @csrf
        ...
        <td>
          <a href="javascript: document.getElementById('delete-{{$item->id}}').submit()" class="btn btn-danger">Eliminar</a>
            <form id="delete-{{$item->id}}" action=" {{route('freido.borrar', $item->id)}} " method="POST">
              @method('delete')
              @csrf
            </form>
        </td>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="{{ route('freido.crear') }}" method="POST" >
            @csrf
      <div class="modal-body">
